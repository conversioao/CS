...
const Generate = () => {
    ...
    const fetchModels = async () => {
      ...
      try {
        ...
        if (data && data.length > 0) {
          ...
          const initialModel = data.find(m => m.name === initialModelName) || data[0];
  ...
  useEffect(() => {
    const selected = models.find(m => m.name === modelo);
    if (selected) {
      setCreditCost(selected.credit_cost);
    }
  }, [modelo, models]);
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 relative flex flex-col">
                ...
                {isLoading ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {generatedImages.map((image) => (
                      <Card key={image.id} className="overflow-hidden group hover:shadow-xl hover:shadow-primary/20 transition-all duration-300">
                  ...
                  <div className="col-span-full flex-1 flex flex-col items-center justify-center text-center">
                    <div className="w-20 h-20 rounded-lg bg-muted/50 flex items-center justify-center mb-4">
          ...
          <div className="w-full max-w-4xl mx-auto pt-8 sticky bottom-0 pb-6 bg-background">
            {imageToEdit ? (
              <div className="relative rounded-xl bg-card/80 backdrop-blur-xl border border-border/50 p-2 shadow-lg">
              ...
              <div className="relative flex items-center gap-1 rounded-full bg-card/80 backdrop-blur-xl border border-border/50 p-2 shadow-lg">
                ...
                {uploadedImageUrl && (
                  <div className="absolute -top-14 left-12 w-12 h-12 rounded-lg overflow-hidden border-2 border-primary shadow-lg">
